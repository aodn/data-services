...
find $STAGING/ACORN/acorn-migration-hierarchy/radial/ -type f -amin +5 -name "*FV00_radial.nc" -printf %P\\n | sort > /tmp/move_FV00_radial.$$.list
...
cat /tmp/move_FV00_radial.$$.list | xargs -I {} isCorruptedNC.sh $STAGING/ACORN/acorn-migration-hierarchy/radial/{} /tmp/isCorruptedNC.$$.list
