...
test_match_regex() {
    ...
    bad_files="$bad_files IMOS_ACORN_RV_20120507T053500Z_CSP_FV01_radial.nc"
    bad_files="$bad_files IMOS_ACORN_W_20090808T023000Z_CBG_FV01_wavespec.nc"
    bad_files="$bad_files IMOS_ACORN_MW_20110921T083000Z_SAG_FV01_windp.nc"
    bad_files="$bad_files IMOS_ACORN_W_20110921T053000Z_SAG_FV01_wavep.nc"
    bad_files="$bad_files IMOS_ACORN_W_20110921T053000Z_CSP_FV01_wavep.nc"
    bad_files="$bad_files IMOS_ACORN_V_20150301T013000Z_CBG_FV01_1-hour-avg.nc"
