...
/usr/bin/find /mnt/imos-t4/IMOS/staging/ACORN/radial/ -type f -amin +1 -name "*FV00_radial.nc" -printf %P\\0 | rsync -a --remove-source-files --files-from=- --from0 /mnt/imos-t4/IMOS/staging/ACORN/radial/ /mnt/imos-t3/IMOS/opendap/ACORN/radial/
