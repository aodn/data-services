...
for iFile=1:Nsheet
    ...
    systemCmd = sprintf('xls2csv_PERL -x "%s" -f -b WINDOWS-1253 -a UTF-8 -n %d -c "%s"  ;',filenameXLS,iFile,filenameCSV);
    [~,~]=system(systemCmd) ;
...
[~,~]=system(systemCmd,'-echo') ;   
    ...
    %xls2csv_PERL -x "IMOS_SRS-OC-BODBAW_B_19971201T052600Z_FR1097-absorption_END-19971207T180500Z.xls" -b WINDOWS-1252 -a UTF-8  -n 1 -c "output1.csv" ;
end
