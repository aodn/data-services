function [FileNameCSV,FileNameNC,folderHierarchy]=createPigmentFilename(DATA,METADATA)
%% createPigmentFilename
...
folderHierarchy=strrep(strcat(datestr(min(TIME),'yyyy'),'_cruise-',char(cruise_id),filesep,'pigment'),' ','-');
end