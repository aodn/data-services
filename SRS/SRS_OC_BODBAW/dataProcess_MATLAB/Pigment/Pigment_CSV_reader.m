function [DATA,METADATA]=Pigment_CSV_reader(FileToConvert)
%% Pigment_CSV_reader
% this function reads the pigment CSV file following a defined template
% provided by IMOS (template/pigment_template.xls). If this template is
...
% error.
% Syntax:  [DATA,METADATA]=Pigment_CSV_reader(FileToConvert)
%
...
%
% Example:
%    [DATA,METADATA]=Pigment_CSV_reader(FileToConvert)
%
% Other m-files
% required:
