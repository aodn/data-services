...
%         csvChangeDelimiter(fullfile(CSVfolder,folderHierarchy,char(FileNameCSV)))
        CreateBioOptical_AC9_HS6_SQL_fromCSV(DATA,METADATA,FileNameCSV,FileNameNC,folderHierarchy)
...
%         plot_AC9_HS6_portal(fullfile(DataFileFolder,filesep,'NetCDF',filesep,folderHierarchy,filesep,char(FileNameNC)),char(FileNameCSV))
