function CreateBioOptical_Absorption_NetCDF2(DATA,METADATA,FileNameNC,folderHierarchy)
...
STATION=strrep(DATA.Values_Row{:,StationIdx},' ','');%remove blank space from strings for the station name
...
strArray_time_station=strcat(DATA.Values_Row{:,TimeIdx},'_', STATION);
...
TimeForNetCDF=(datenum(DATA.Values_Row{:,TimeIdx},'yyyy-mm-ddTHH:MM:SS') -datenum('1970-01-01','yyyy-mm-dd')); %num of day
