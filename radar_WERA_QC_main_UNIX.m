function [toto] = radar_WERA_QC_main_UNIX(site_code)
%
%
%
%The text file 'SAG_QC_last_update.txt' contains the date of the last update one
...
%
global dfradialdata
dfradialdata = '/home/matlab_3/datafabric_root/opendap/ACORN/radial_quality_controlled/';
global inputdir
inputdir = '/var/lib/matlab_3/ACORN/WERA/radial_QC/';
global outputdir
outputdir = '/var/lib/matlab_3/ACORN/WERA/radial_QC/output/';
global ncwmsdir
ncwmsdir = '/var/lib/netcdf_data/matlab_3/ncwms.emii.org.au_ncwms_data/WERA_QC/';
%
...
switch site_code
    case {'GBR','CBG'}
        station1 = 'TAN';
        station2 = 'LEI';
        filelastupdate = strcat(inputdir,'CBG_QC_last_update.txt');
    case 'SAG'
        station1 = 'CWI';
        station2 = 'CSP';
        filelastupdate = strcat(inputdir,'SAG_QC_last_update.txt');
    case {'PCY','ROT'}
        station1 = 'GUI';
        station2 = 'FRE';
        filelastupdate = strcat(inputdir,'ROT_QC_last_update.txt');
end
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Call the subfunction "radar_WERA_QC_subfunction1_UNIX"
...
test_subf1_1 = 0;
try
    final = radar_WERA_QC_subfunction1_UNIX(year,month,day,hour,station1);
    test_subf1_1 = 1;
catch
...
test_subf1_2 = 0;
try
    final2 = radar_WERA_QC_subfunction1_UNIX(year,month,day,hour,station2);
    test_subf1_2 = 1;
catch
        fid_w5 = fopen(logfile, 'a');
        fprintf(fid_w5,'%s %s %s %s\r\n',datestr(clock),station1,'Problem in subroutine1 to access files for this station on the following date',data{1});
...
%to create a new NetCDF file (1 hour averaged product)
        try
            toto = radar_WERA_QC_subfunction2_UNIX(namefile,site_code,k);
            toto
            k=k+1;
