#!/bin/bash
DEFAULT_BACKUP_RECIPIENT=benedicte.pasquer@utas.edu.au
PATH_EVALUATION_EXECUTABLE='CSIRO/Ocean_Acidification/dest_path.py'
...
main() {
    local file=$1; shift
    local regex="OA_Reconstruction.nc"
