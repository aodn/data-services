function [channelInfo]=createInformationListfromChannelsFAIMMS(xmlStructure)
%% createInformationListfromChannelsFAIMMS
...
%
% Example: 
%    createInformationListfromChannelsFAIMMS(xmlStructure)
%
...
for i=1:b
    ...
    lat{k}=xmlStructure.channel{1,1}.item{1,i}.lat{1,1}.CONTENT;
    long{k}=xmlStructure.channel{1,1}.item{1,i}.long{1,1}.CONTENT;
    metadata_uuid{k}=xmlStructure.channel{1,1}.item{1,i}.metadataLink{1,1}.CONTENT;
    platformName{k}=xmlStructure.channel{1,1}.item{1,i}.platformName{1,1}.CONTENT;
    parameterType{k}=xmlStructure.channel{1,1}.item{1,i}.parameterType{1,1}.CONTENT;
    ...
    siteName{k}=xmlStructure.channel{1,1}.item{1,i}.siteName{1,1}.CONTENT;
    title{k}=xmlStructure.channel{1,1}.item{1,i}.title{1,1}.CONTENT;
