...
class TestABOSFileClassifier(unittest.TestCase):
    ...
    * FluxPulse RT
    ...
    def test_da_temperature(self):
        filename = 'IMOS_ABOS-DA_TZ_20120426T092000Z_EAC5_FV01_EAC5-2012-STARMON-MINI-300_END-20130826T222000Z_C-20140722T061401Z.nc'
    ...
    def test_da_ctd_timeseries(self):
        filename = 'IMOS_ABOS-DA_STZ_20120426T092000Z_EAC5_FV01_EAC5-2012-SBE37SMP-202_END-20130826T222000Z_C-20140722T061531Z.nc'
        testfile = os.path.join(self.tempdir, filename)
        make_test_file(testfile, {'platform_code':'EAC5', 'featureType':'timeSeries'},
                       TEMP={},
                       PSAL={},
    ...
    def test_sots_ctd_timeseries(self):
        filename = 'IMOS_ABOS-SOTS_20120718T052204Z_SAZ_FV01_SAZ-15-microcat-4422m-2012_END-20131008T190000Z_C-20131216T221210Z.nc'
        testfile = os.path.join(self.tempdir, filename)
    ...
    def test_da_bgc_timeseries(self):
        filename = 'IMOS_ABOS-DA_CEOSTZ_20140218T000057Z_TOTTEN1_FV01_TOTTEN1-SBE37SMP-ODO-9880_END-20150103T230035Z_C-20160112T020000Z.nc'
        testfile = os.path.join(self.tempdir, filename)
    ...
    def test_da_velocity(self):
        filename = 'IMOS_ABOS-DA_AETVZ_20140204T000000Z_TOTTEN1_FV01_TOTTEN1-WORKHORSE-ADCP-14489_END-20150103T224000Z_C-20160112T020000Z.nc'
        testfile = os.path.join(self.tempdir, filename)
        make_test_file(testfile, {'platform_code':'TOTTEN1', 'featureType':'timeSeries'},
                       UCUR={},
                       VCUR={},
    ...
    def test_sots_velocity(self):
        filename = 'IMOS_ABOS-SOTS_AETVZ_20100912T224200Z_SAZ47_FV01_SAZ47-13-2010-Aquadopp-Current-Meter-1100_END-20110804T053000Z_C-20140826T062213Z.nc'
        testfile = os.path.join(self.tempdir, filename)
    ...
    def test_sots_sediment_traps(self):
        filename = 'IMOS_ABOS-SOTS_RFK_20120724T000000Z_SAZ47_FV01_SAZ47-2012Sediment-Trap-Data_20130828T000000Z_C-20150210T043901Z.nc'
        testfile = os.path.join(self.tempdir, filename)
        make_test_file(testfile, {'featureType':'timeSeries', 'site_code':'SOTS', 'platform_code':'SAZ47'},
                       DEPTH={},
                       MASS_FLUX={},
