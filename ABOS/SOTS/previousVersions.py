#! /usr/bin/env python
#
# Find any previous versions of a given ABOS SOTS
...
def previousVersions(new_file, dest_path):
    """For an ABOS SOTS NetCDF file (ncFile) due to be published to
    destPath (given as a FULL PATH), find any previous versions of the
    file already there. Return a list of the full path of matching
    files.
...
if __name__=='__main__':
    ...
    parser.add_argument('new_file', help='new file to be published')
