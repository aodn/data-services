...
class TestSOFSFileClassifier(unittest.TestCase):
    ...
    * Surface_waves RT
    ...
    def test_subsurface_currents(self):
        filename = 'IMOS_ABOS-ASFS_AETVZ_20130504T003015Z_SOFS_FV01_SOFS-4-2013-Workhorse-ADCP-500_END-20151212T000000Z_C-20140826T064252Z.nc'
    ...
    def test_waves_dm(self):
        filename = 'IMOS_ABOS-ASFS_RW_20150101T000000Z_SOFS_FV00_SOFS-2-2011-TriAXYS_END-20151212T000000Z_C-20140708T230346Z.nc'
        testfile = os.path.join(self.tempdir, filename)
        make_test_file(testfile,
                       {'time_coverage_start':'2015-01-01T00:00:00Z',
                        'time_coverage_end':'2015-12-12T00:00:00Z'},
    ...
    def test_surface_properties_dm(self):
        filename = 'IMOS_ABOS-ASFS_RTSCP_20150101T000000Z_SOFS_FV00_SOFS-3-2012_END-20151212T000000Z_C-20140730T112324Z.nc'
        testfile = os.path.join(self.tempdir, filename)
        make_test_file(testfile,
                       {'time_coverage_start':'2015-01-01T00:00:00Z',
                        'time_coverage_end':'2015-12-12T00:00:00Z'},
    ...
    def test_surface_fluxes_dm(self):
        filename = 'IMOS_ABOS-ASFS_FMT_20150101T000000Z_SOFS_FV02_SOFS-1-2010_END-20151212T000000Z_C-20120906T022400Z.nc'
        testfile = os.path.join(self.tempdir, filename)
        make_test_file(testfile,
                       {'time_coverage_start':'2015-01-01T00:00:00Z',
                        'time_coverage_end':'2015-12-12T00:00:00Z'},
