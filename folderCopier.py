...
class folderCopier:
    ...
    def __init__(self):
        ...
        This script is designed for Datafabric idosyncrasies
...
if __name__ == "__main__":
	...
	"""
        ...
        #f.processFiles("/usr/local/emii/data/matlab/AATAMS/processed_data/CSV","public/AATAMS/sattag",'csv')
        #f.processFiles("/usr/local/emii/data/matlab/AATAMS/processed_data/NETCDF","opendap/AATAMS/sattag",'nc')
        #f.processFiles("/usr/local/emii/data/matlab/AATAMS/processed_data/CSV","/tmp/public/AATAMS/sattag",'csv')
        #f.processFiles("/usr/local/emii/data/matlab/AATAMS/processed_data/NETCDF","/tmp/opendap/AATAMS/sattag",'nc')
        #f.close()
